...
import (
	...
	chartDataset "github.com/marianogappa/ch/dataset"
)
...
func New(chartType ChartType, ds chartDataset.Dataset, opts Options) ChartJS {
	...
	if chartType == Bar {
		opts.ZeroBased = true // https://github.com/marianogappa/ch/issues/11
	}
...
func (c ChartJS) prepareLabelsAndDatasets() cjsData {
	...
	case "denormalised-scatterline":
		...
		sort.Slice(dss, func(i, j int) bool { // https://github.com/marianogappa/ch/issues/33
