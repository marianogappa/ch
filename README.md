...
or get the latest binary for your OS in the [Releases section](https://github.com/marianogappa/ch/releases).
...
- Javascript's floating point messes up y-axis https://github.com/marianogappa/ch/issues/15
- No histogram support (ChartJS doesn't provide it) https://github.com/marianogappa/ch/issues/22

## Contribute

PRs are greatly appreciated and are currently [being merged](https://github.com/marianogappa/ch/pull/3).
If you have a use case that is not supported by `chart`, [I'd love to hear about it](https://github.com/marianogappa/ch/issues), but if it's too complex I'd recommend you to try [gnuplot](http://www.gnuplot.info/).
